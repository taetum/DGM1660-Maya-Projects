...
//Last modified: Wed, Nov 16, 2022 04:15:27 PM
//Codeset: 1252
requires maya "2023";
...
fileInfo "UUID" "611CC17F-4FF7-4B51-4DD4-2ABDC03664B4";
createNode transform -s -n "persp";
	rename -uid "E377311C-44BB-EA75-3F7F-76B8F9066887";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.7062902670472653 32.299081646740476 -21.517636758034232 ;
	setAttr ".r" -type "double3" -23.138352728630149 -173.40000000032285 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "5216630D-4EF9-D835-AF82-0F8F6282DD2C";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 24.046147683793883;
...
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.44999989867210388 0.5 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1554ADC7-4176-D821-9874-A9BB31A5FA9E";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "33171B96-4557-EDD4-BC13-9A9E9F8EFA69";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "D1D40D77-440A-524D-2DA1-09928BA86930";
createNode displayLayerManager -n "layerManager";
	rename -uid "901504B4-43A2-7A85-BB2E-569AA0326DC8";
createNode displayLayer -n "defaultLayer";
	rename -uid "D224774A-4F2C-3876-EBB9-26814D19059A";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "88381C2A-4B93-65A8-FCF1-31BCD1F904DA";
...
createNode polyTweak -n "polyTweak19";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".tk";
	setAttr ".tk[296]" -type "float3" -0.037387773 0.29771131 -0.056345433 ;
	setAttr ".tk[297]" -type "float3" -0.037387796 0.073333248 -0.056345493 ;
	setAttr ".tk[298]" -type "float3" 0.037388053 0.29771131 0.055833146 ;
	setAttr ".tk[299]" -type "float3" 0.037387967 0.073333256 0.055833042 ;
	setAttr ".tk[300]" -type "float3" -0.03738793 -0.090464756 -0.056345697 ;
	setAttr ".tk[301]" -type "float3" 0.037387908 -0.090464748 0.055833027 ;
	setAttr ".tk[302]" -type "float3" -0.037388053 -0.29771116 -0.056345902 ;
	setAttr ".tk[303]" -type "float3" 0.03738787 -0.29771131 0.055832967 ;
...
createNode polyTweak -n "polyTweak20";
	...
	setAttr ".uopa" yes;
	setAttr -s 21 ".tk";
	setAttr ".tk[882]" -type "float3" -0.16675529 0 2.3118481e-08 ;
	setAttr ".tk[883]" -type "float3" -0.15859351 0 -0.051530194 ;
	setAttr ".tk[884]" -type "float3" -0.13490802 0 -0.098016292 ;
	setAttr ".tk[885]" -type "float3" -0.098016284 0 -0.13490805 ;
	setAttr ".tk[886]" -type "float3" -0.051530194 0 -0.15859357 ;
	setAttr ".tk[887]" -type "float3" 1.9877488e-08 0 -0.1667551 ;
	setAttr ".tk[888]" -type "float3" 0.051530309 0 -0.15859357 ;
	setAttr ".tk[889]" -type "float3" 0.098016351 0 -0.13490799 ;
	setAttr ".tk[890]" -type "float3" 0.13490793 0 -0.098016292 ;
	setAttr ".tk[891]" -type "float3" 0.15859383 0 -0.051530179 ;
	setAttr ".tk[892]" -type "float3" 0.16675529 0 2.3118481e-08 ;
	setAttr ".tk[893]" -type "float3" 0.15859345 0 0.051530179 ;
	setAttr ".tk[894]" -type "float3" 0.13490802 0 0.098016232 ;
	setAttr ".tk[895]" -type "float3" 0.098016262 0 0.13490799 ;
	setAttr ".tk[896]" -type "float3" 0.051530179 0 0.15859362 ;
	setAttr ".tk[897]" -type "float3" 1.4907762e-08 0 0.1667551 ;
	setAttr ".tk[898]" -type "float3" -0.051530201 0 0.15859362 ;
	setAttr ".tk[899]" -type "float3" -0.098016322 0 0.13490793 ;
	setAttr ".tk[900]" -type "float3" -0.13490796 0 0.098016351 ;
	setAttr ".tk[901]" -type "float3" -0.15859351 0 0.051530227 ;
...
createNode polyTweak -n "polyTweak22";
	...
	setAttr ".uopa" yes;
	setAttr -s 8 ".tk";
	setAttr ".tk[929]" -type "float3" 0 0.0045272666 0 ;
	setAttr ".tk[930]" -type "float3" 0 0.0045272666 0 ;
	setAttr ".tk[931]" -type "float3" 0 0.0045272666 0 ;
	setAttr ".tk[932]" -type "float3" 0 0.0045272666 0 ;
	setAttr ".tk[933]" -type "float3" 0 0.0045272666 0 ;
	setAttr ".tk[934]" -type "float3" 0 0.0045272666 0 ;
	setAttr ".tk[935]" -type "float3" 0 0.0045272666 0 ;
...
createNode polyTweak -n "polyTweak23";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".tk";
	setAttr ".tk[936]" -type "float3" 0 0.0042461259 0 ;
	setAttr ".tk[937]" -type "float3" 0 0.0042461259 0 ;
	setAttr ".tk[938]" -type "float3" 0 0.0042461259 0 ;
	setAttr ".tk[939]" -type "float3" 0 0.0042461259 0 ;
	setAttr ".tk[940]" -type "float3" 0 0.0042461259 0 ;
	setAttr ".tk[941]" -type "float3" 0 0.0042461259 0 ;
	setAttr ".tk[942]" -type "float3" 0 0.0042461259 0 ;
	setAttr ".tk[943]" -type "float3" 0 0.0042461259 0 ;
...
createNode polyTweak -n "polyTweak24";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[944]" -type "float3" 0 0.0020034094 0 ;
	setAttr ".tk[945]" -type "float3" 0 0.0020034094 0 ;
	setAttr ".tk[946]" -type "float3" 0 0.0020034094 0 ;
	setAttr ".tk[947]" -type "float3" 0 0.0020034094 0 ;
